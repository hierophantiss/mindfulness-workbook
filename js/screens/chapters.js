      ...
      <div class="chapters-container">
        ...
        <section class="ch-group">
          <header class="ch-group-header" style="text-align: center; padding-top: 32px;">
            <div style="color: #e89e6e; font-size: 24px; font-family: var(--font-display); font-weight: 500; font-style: normal; line-height: 1.25; margin-bottom: 20px; letter-spacing: -0.2px;">
...
window.openPracticeItem = openPracticeItem;
