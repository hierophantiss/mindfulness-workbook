...
function showSOSModal(onAccept) {
  ...
  modal.innerHTML = '<div style="max-width:380px;width:100%;background:#0d1b2a;border:1px solid rgba(100,180,210,0.2);border-radius:16px;padding:28px 24px;text-align:center;font-family:inherit">'
    + '<div style="font-size:40px;margin-bottom:12px">🆘</div>'
    + '<h2 style="font-family:inherit;font-size:20px;color:rgba(100,180,210,0.8);margin-bottom:12px;font-weight:700">'
...
window.deactivateSOS = deactivateSOS;
window.addSOSButton = addSOSButton;
