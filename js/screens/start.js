    ...
    <div class="scroll-area">
      ...
      <div class="start-container">
        ...
        <div class="start-actions-grid">
          ...
          <button class="btn-primary" onclick="window.c2ToggleSheet()" style="background:var(--accent-purple); border-color:var(--accent-purple)">
            ✨ ${t('navAI')}
          </button>
...
window.buildStartScreen = buildStartScreen;
