...
var _origSwitchPattern = (typeof switchPattern === 'function') ? switchPattern : null;
if (_origSwitchPattern) {
  switchPattern = function(key) {
    if (breathAudioOn) stopBreathAudio();
