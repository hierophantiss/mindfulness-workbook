...
window.applySpatialMovement = applySpatialMovement;
window.createImpulseResponse = createImpulseResponse;
window.createLimiter = createLimiter;
window.loadAudioFile = loadAudioFile;
window.createAudioLayer = createAudioLayer;
window.makeBrownNoise = makeBrownNoise;
window.makePinkNoise = makePinkNoise;
