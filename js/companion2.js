...
function c2ShowSheet() {
    ...
    var contentDiv = document.getElementById('c2-content');
    // Only show main menu if the sheet is completely empty
...
function c2ShowMainMenu() {
    ...
    html += `<div class="c2-menu">
            ...
            ${c2MenuBtn('🧭', lang === 'el' ? 'Καθοδήγηση AI' : 'AI Guidance', "window.c2RunApiTurn('User asks: What to do? Give me some guidance.')")}
        </div>`;
    c2SetContent(html);
}
