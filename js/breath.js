...
const B_PATTERNS = {
  '4-2-6-1': {
    ...
    desc_el: 'Binaural Alpha (10Hz) & Αργή εκπνοή — Gerritsen & Band (2018)',
    desc_en: 'Binaural Alpha (10Hz) & Slow exhale — Gerritsen & Band (2018)',
    phases: [
  ...
  '4-7-8': {
    ...
    desc_el: 'Binaural Theta (4Hz) & Μέθοδος Dr. Andrew Weil',
    desc_en: 'Binaural Theta (4Hz) & Dr. Andrew Weil method',
    phases: [
      { dur: 4000, armFrom: 0, armTo: 1, labelKey: 0 },
