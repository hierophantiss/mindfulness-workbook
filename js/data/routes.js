...
var CONVERSATION_FLOWS = {
  ...
  // ─── DAILY INVENTORY (AI powered) ───
  dailyInventory: {
    id: 'dailyInventory',
    title: { el: 'Απογραφή Ημέρας', en: 'Daily Inventory' },
    steps: [
      {
        id: 'start',
        text: { el: 'Θέλεις να κάνουμε μια ανασκόπηση της ημέρας σου;', en: 'Would you like to do a review of your day?' },
        type: 'select',
        options: [
          { label: { el: '📊 Ναι, κάνε απογραφή', en: '📊 Yes, do inventory' }, run: "window.c2RunApiTurn('USER_REQUESTED_DAILY_INVENTORY')" },
          { label: { el: '✕ Όχι ακόμα', en: '✕ Not yet' }, next: 'end' }
        ]
      }
    ]
  },
...
window.MOOD_ROUTES = MOOD_ROUTES;
window.CONVERSATION_FLOWS = CONVERSATION_FLOWS;
